...
/**
 * Represents the maze in the Pacman game.
 */
public class Maze implements CommonMaze {
  ...
  /**
   * Returns a copy of the list of boosts in the Maze.
   *
   * @return a copy of the list of boosts in the Maze.
   */
  @Override
  ...
  /**
   * Sets the initial objects' layout of the Maze to the specified layout.
   *
   * @param objectsLayout  the initial objects' layout to set in the Maze.
   */
  @Override
  ...
  /**
   * Restores the game to its initial state by clearing all fields and objects and then restoring the initial
   * objects' layout. Additionally, it resets the Pacman object.
   */
  @Override
  ...
  /**
   * Sets the list of boosts in the Maze to the specified list.
   *
   * @param listOfBoosts the list of boosts to set in the Maze.
   */
