...
public class Maze implements CommonMaze {
  ...
  /**
   * Sets objects' layout of the Maze to the specified layout.
   *
   * @param objectsLayout  the objects' layout to set in the Maze.
   */
  @Override
  ...
  /**
   * Restores the initial state of the Maze by clearing all fields and objects and then restoring the initial
   * objects' layout. Also resets the Pacman object.
   */
  @Override
