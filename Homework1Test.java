...
public class Homework1Test {
    ...
    public void test03() {
        ...
        for (int c = 0; c < 5; c++) {
            Object f1 = new WallField(0,c);
            Object f2 = maze.getField(0, c);
        ...
        Object f1 = new WallField(2,2);
        Object f2 = maze.getField(2, 2);
        Assert.assertEquals("Pole reprezentujici zed", f1, f2);
        Assert.assertTrue("Pole reprezentujici zed nema zadny objekt", f2.isEmpty());
        Assert.assertFalse("Na pole reprezentujici zed se nelze presunout", f2.canMove());

        Object f3 = new PathField(2,1);
        f1 = new WallField(2,1);
        Object f4 = maze.getField(2, 1);
        ...
        Object f5 = new PathField(4,2);
        Object f6 = maze.getField(4, 2);
    ...
    public void test04() {
        ...
        Object f1 = maze.getField(4, 2);
        Object f2 = f1.nextField(Field.Direction.R);
        Object f3 = f1.nextField(Field.Direction.D);
